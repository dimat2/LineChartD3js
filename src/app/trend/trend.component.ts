...
export class TrendComponent implements OnInit {
  ...
  private async grafikon() : Promise<void> {
    ...
    const data = await d3.csv("assets/04_trending.csv", d3.autoType);
    ...
    const z = d3.scaleOrdinal()
		...
		.range(["#1e8449", "#FF8C00", "#FFA500"]);
    
        
    const svg = d3.select("figure#trend").append('svg')
